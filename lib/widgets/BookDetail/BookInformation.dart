      ...
      children: <Widget>[
          ...
          children: <Widget>[
            ...
            Expanded(
              child: Container(
                height: 160.0,
                padding:
                    const EdgeInsets.only(right: 26.0, top: 8.0, bottom: 8.0),
                child: Column(
                            ...
                            Padding(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                    ...
                                    color:
                                        const Color(AppColors.fontColorYellow)),
                              ),
                            )
                          ],
                        ),
        ...
        Container(
          ...
          decoration: BoxDecoration(
              border: Border(
            top: BorderSide(color: Color(AppColors.borderColor)),
            bottom: BorderSide(color: Color(AppColors.borderColor)),
          )),
          child: Row(
            children: _iconList
