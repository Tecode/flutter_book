...
import 'package:flutter_book/widgets/common/circular_progress.dart';
import 'package:flutter_book/widgets/common/clipper.dart';

// The over-scroll distance that moves the indicator to its maximum
// displacement, as a percentage of the scrollable's container extent.
const double _kDragContainerExtentPercentage = 0.25;

// How much the scroll's drag gesture can overshoot the PullRefresh's
// displacement; max displacement = _kDragSizeFactorLimit * displacement.
const double _kDragSizeFactorLimit = 1.5;

// When the scroll ends, the duration of the progress indicator's animation
// to the PullRefresh's displacement.
...
/// [PullRefresh] far enough to demonstrate that they want the app to
/// refresh. The returned [Future] must complete when the refresh operation is
/// finished.
///
/// Used by [PullRefresh.onRefresh].
...
class _LiquidPullToRefreshState extends State<PullRefresh>
  ...
  void _show() {
    ...
    _springController
      ...
      if (mounted && _mode == _LiquidPullToRefreshMode.snap) {
        ...
        assert(() {
          var flutterErrorDetails = FlutterErrorDetails(
  ...
  ///
  /// Creating the [PullRefresh] with a [GlobalKey<LiquidPullToRefreshState>]
  /// makes it possible to refer to the [LiquidPullToRefreshState].
  ///
  /// The future returned from this method completes when the
  /// [PullRefresh.onRefresh] callback's future completes.
  ///
